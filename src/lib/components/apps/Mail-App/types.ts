import { Inbox, Send, FileText, Trash2, Archive, ShieldX } from 'lucide-svelte';

export interface EmailAddress { name: string; email: string; }
export interface Attachment { name: string; size: string; type: string; }
...
export interface ComposeData { to: string; cc: string; subject: string; body: string; replyTo?: Email; }
